...
#' @name get_boltzmann
#' @export
get_boltzmann = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE) UseMethod("get_boltzmann")

#' @name get_boltzmann
#' @export
get_boltzmann.default = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE){
  if (method == "hierarchy"){
...
##' @name get_boltzmann
##' @export
get_boltzmann.matrix = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE){
  if (method == "hierarchy"){
    result = get_boltzmann_default(x, base, relative)
  } else if (method == "aggregation"){
    result = get_boltzmann_aggregation(x, base, relative)
...
#' @name get_boltzmann
#' @export
get_boltzmann.array = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE){
  if (method == "hierarchy"){
  ...
  if (scale){
    result = result / ((ncol(x) * nrow(x)) * apply(x, MARGIN = 3, not_na_prop))
  }
  return(result)
}
...
#' @name get_boltzmann
#' @export
get_boltzmann.RasterLayer = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE){
  ...
  get_boltzmann(raster::as.matrix(x), base = base, relative = relative, method = method, scale = scale)
}

#' @name get_boltzmann
#' @export
get_boltzmann.RasterStack = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE){
  if (!requireNamespace("sp", quietly = TRUE))
    stop("Package sp required, please install it first", call. = FALSE)
  if (!requireNamespace("raster", quietly = TRUE))
    stop("Package raster required, please install it first", call. = FALSE)
  get_boltzmann(raster::as.array(x), base = base, relative = relative, method = method, scale = scale)
}

#' @name get_boltzmann
#' @export
get_boltzmann.RasterBrick = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE){
  if (!requireNamespace("sp", quietly = TRUE))
    stop("Package sp required, please install it first", call. = FALSE)
  if (!requireNamespace("raster", quietly = TRUE))
    stop("Package raster required, please install it first", call. = FALSE)
...
#' @name get_boltzmann
#' @export
get_boltzmann.stars = function(x, base = "log10", relative = FALSE, method = "hierarchy", scale = FALSE){
  ...
  get_boltzmann(x[[1]], base = base, relative = relative, method = method, scale = scale)
}
