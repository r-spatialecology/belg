...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.1194872.svg)](https://doi.org/10.5281/zenodo.1194872)

Boltzmann entropy (also called configurational entropy) has been recently applied to analyze entropy of landscape gradients (Gao et al. (2017), Gao et al.(2018)).
The goal of **belg** is to provide an efficient implementation (in C++) of the method for calculation of the landscape gradient's Boltzmann entropy in R.
